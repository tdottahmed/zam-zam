...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/orders/search-products', [\App\Http\Controllers\OrderController::class, 'searchProducts'])->name('orders.search-products');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Admin\SettingsController::class)->prefix('settings')->name('settings.')->group(function () {
        ...
        Route::post('health/forget/{uuid}', 'forgetFailedJob')->name('health.forget');
        Route::post('health/flush', 'flushFailedJobs')->name('health.flush');
