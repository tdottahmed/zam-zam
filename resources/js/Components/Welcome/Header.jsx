    ...
    return (
        <>
                ...
                <div className="bg-[#111111] text-white py-2 px-4 lg:px-8 text-[11px] uppercase tracking-widest font-medium border-b border-gray-800">
                    <div className="max-w-[1920px] mx-auto flex justify-between items-center">
                        ...
                        <p className="hidden md:block opacity-80">
                            Leading South Asian Product Distributor in Canada
                        </p>
                        <div className="flex gap-6 items-center w-full md:w-auto justify-between md:justify-end">
                            ...
                            <div className="flex items-center space-x-2 opacity-80 hover:text-[#C41E3A] hover:opacity-100 transition cursor-pointer">
                                ...
                                <span>
                                    {settings?.contact_phone || "Contact Us"}
                                </span>
                            </div>
                            <Link
                                href={route("login")}
                                className="opacity-80 hover:text-[#C41E3A] hover:opacity-100 transition"
                            >
                                Partner With Us
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center justify-between h-20">
                            ...
                            <div className="hidden lg:flex items-center space-x-8 xl:space-x-12 px-8">
                                {[
                                    ...
                                    >
                                        {item.label}
                                        <span
                                            className={`absolute bottom-0 left-0 w-full h-0.5 bg-[#C41E3A] transform origin-left transition-transform duration-300 
                            ...
                            <div className="flex items-center justify-end space-x-2 lg:space-x-5 flex-1 lg:flex-none">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        onClick={openCart}
                                        className="hidden lg:flex p-2 text-gray-700 hover:text-[#C41E3A] transition relative"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                        ...
                                        >
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 5c.07.277-.144.516-.41.488a10.977 10.977 0 0 1-5.26 1.508 10.979 10.979 0 0 1-5.26-1.508c-.266.028-.48-.21-.41-.488l1.263-5a.49.49 0 0 1 .454-.368 18.243 18.243 0 0 0 3.955-.42 18.22 18.22 0 0 0 3.955.42c.174 0 .332.13.454.368Z"
                                            />
                                        </svg>
                                        {displayCount > 0 && (
                                ...
                                <div className="hidden lg:block">
                                    {auth.user ? (
                                        <Link
                                            ...
                                            className="flex items-center gap-2 text-gray-700 hover:text-[#C41E3A] text-sm font-bold uppercase tracking-wide ml-4"
                                        >
                                        ...
                                        <Link
                                            href={route("login")}
                                            className="ml-4 bg-[#C41E3A] text-white px-7 py-2.5 rounded-full font-bold text-xs uppercase tracking-wider shadow-lg shadow-red-100 hover:shadow-red-200 hover:bg-[#a91930] transform hover:-translate-y-0.5 transition-all duration-300"
                                        >
                                            Login
                                        </Link>
                                    )}
            ...
            >
                ...
                {/* Drawer */}
                <div
                    className={`absolute top-0 left-0 h-full w-[80%] max-w-[300px] bg-white shadow-2xl transform transition-transform duration-300 flex flex-col ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"}`}
                >
