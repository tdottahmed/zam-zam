                                                ...
                                                <div className="flow-root">
                                                    {cart && cart.items && cart.items.length > 0 ? (
                                                                    ...
                                                                    <div className="ml-4 flex flex-1 flex-col">
                                                                        <div>
                                                                            <div className="flex justify-between text-base font-medium text-gray-900">
                                                                                <h3 className="line-clamp-2">
                                                                                     <Link href={route('shop.show', item.product_id)} onClick={closeCart}>
                                                                                        {item.name}
                                                                                    </Link>
                                                                                </h3>
                                                                                <p className="ml-4 tabular-nums">${item.total.toFixed(2)}</p>
                                                                            </div>
                                                                            <p className="mt-1 text-sm text-gray-500">{item.unit_price} / {item.unit}</p>
                                                                        </div>
                                                                        <div className="flex flex-1 items-end justify-between text-sm">
                                                                            <div className="flex items-center border border-gray-300 rounded overflow-hidden">
                                                                                ...
                                                                                <span className="px-3 py-1 font-medium text-gray-900 min-w-[2rem] text-center bg-white">{item.quantity}</span>
                                                                                <button 
                                                                                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                                                                            ...
                                                                            <div className="flex">
                                                                                <button
                                                                                    ...
                                                                                    className="font-medium text-[#C41E3A] hover:text-[#a01830] transition-colors"
                                                                                >
                                                                                    Remove
                                                                                </button>
                                                                            </div>
                                                        ...
                                                        <div className="text-center py-12">
                                                            <div className="inline-flex justify-center items-center w-16 h-16 rounded-full bg-gray-100 mb-4 text-[#C41E3A]">
