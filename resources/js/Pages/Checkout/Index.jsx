...
export default function Checkout({ addresses = [], shippingMethods = [] }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        shipping_method_id: shippingMethods.length > 0 ? shippingMethods[0].id : null,
    });
        ...
        <CustomerLayout>
            ...
            <div className="bg-gray-50/50 min-h-screen py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                        {/* Left Column: Forms */}
                        <div className="flex-1 space-y-8">
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <section className={`bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 ${selectedAddressId !== 'new' ? 'opacity-75 grayscale-[0.5] pointer-events-none' : ''}`}>
                                    <div className="flex justify-between items-center mb-6">
                                        <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                            <svg className="w-5 h-5 text-[#C41E3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                            {selectedAddressId === 'new' ? 'Contact & Shipping' : 'Review Details'}
                                        </h2>
                                        {selectedAddressId !== 'new' && (
                                            <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-1 rounded-full border border-amber-100">Saved Address Selected</span>
                                        )}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            <input
                                                ...
                                                className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#C41E3A] focus:ring-[#C41E3A]/20 transition-colors py-2.5"
                                            />
                                            {errors['shipping_address.name'] && <p className="mt-1 text-sm text-red-600">{errors['shipping_address.name']}</p>}
                                        </div>
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            />
                                            {errors['shipping_address.address'] && <p className="mt-1 text-sm text-red-600">{errors['shipping_address.address']}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#C41E3A] focus:ring-[#C41E3A]/20 transition-colors py-2.5"
                                            />
                                            {errors['shipping_address.city'] && <p className="mt-1 text-sm text-red-600">{errors['shipping_address.city']}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#C41E3A] focus:ring-[#C41E3A]/20 transition-colors py-2.5"
                                            />
                                            {errors['shipping_address.zip'] && <p className="mt-1 text-sm text-red-600">{errors['shipping_address.zip']}</p>}
                                        </div>
                                         <div className="sm:col-span-2">
                                            ...
                                            <input
                                                ...
                                                className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#C41E3A] focus:ring-[#C41E3A]/20 transition-colors py-2.5"
                                            />
                                            {errors['shipping_address.country'] && <p className="mt-1 text-sm text-red-600">{errors['shipping_address.country']}</p>}
                                        </div>
                                        ...
                                        {selectedAddressId === 'new' && (
                                            <div className="sm:col-span-2 mt-2">
                                                <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                                    ...
                                                    />
                                                    <span className="text-sm font-medium text-gray-700">Save this address for next time</span>
                                                </label>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <section className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                                    <svg className="w-5 h-5 text-[#C41E3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                                    Shipping Method
                                </h2>
                                <div className="grid grid-cols-1 gap-4">
                                            ...
                                            <div className="flex items-start gap-4">
                                                <div className="mt-1">
                                                    <input
                                                        ...
                                                        onChange={() => setData('shipping_method_id', method.id)}
                                                        className="h-5 w-5 border-gray-300 text-[#C41E3A] focus:ring-[#C41E3A]"
                                                    />
                                                </div>
                                                <div>
                                                    <span className="block text-base font-semibold text-gray-900">{method.name}</span>
                                                    {method.estimated_delivery_time && (
                                                        <span className="block text-sm text-gray-500 mt-0.5">{method.estimated_delivery_time}</span>
                                                    )}
                                                    {method.description && (
                                    ...
                                    {shippingMethods.length === 0 && (
                                        <p className="text-gray-500 italic p-4 text-center bg-gray-50 rounded-lg">No shipping methods available. Shipping will be calculated later.</p>
                                    )}
                                    {errors.shipping_method_id && <p className="text-sm text-red-600 font-medium">{errors.shipping_method_id}</p>}
                                </div>
                            </section>
                            ...
                            <section className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                                    <svg className="w-5 h-5 text-[#C41E3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                                    Payment Method
                                </h2>
                                <div className="space-y-4">
                                    <label className={`relative flex items-start gap-4 p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${data.payment_method === 'cod' ? 'border-[#C41E3A] bg-red-50/30' : 'border-gray-100 hover:border-gray-200'}`}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-0.5">Pay exactly what you see when you receive your order.</p>
                                        </div>
                                    </label>
                                    
                                    <label className={`relative flex items-start gap-4 p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${data.payment_method === 'bank_transfer' ? 'border-[#C41E3A] bg-red-50/30' : 'border-gray-100 hover:border-gray-200'}`}>
                                        <div className="mt-0.5">
                                            <input
                                                type="radio"
                                                name="payment-method"
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-0.5">Direct bank transfer to our account.</p>
                                        </div>
                                    </label>
                                </div>
                            </section>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 sticky top-6">
                                            ...
                                            <li key={item.id} className="flex gap-4 group">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex justify-between items-start gap-2">
                                                        <div>
                                                            <h3 className="text-sm font-semibold text-gray-900 line-clamp-2 leading-tight group-hover:text-[#C41E3A] transition-colors">{item.name}</h3>
                                                            {item.unit && <p className="mt-0.5 text-xs text-gray-500">{item.unit_price} / {item.unit}</p>}
                                                        </div>
                                                        <p className="text-sm font-bold text-gray-900 tabular-nums">${item.total.toFixed(2)}</p>
                                                    </div>
                                ...
                                <div className="mt-8 space-y-4 pt-6 border-t border-gray-100">
                                    <div className="flex justify-between text-sm text-gray-600">
                                        <span>Subtotal</span>
                                        <span className="font-semibold text-gray-900">${cart.total ? cart.total.toFixed(2) : '0.00'}</span>
                                    </div>
                                    <div className="flex justify-between text-sm text-gray-600">
                                        <span>Shipping</span>
                                        <span className="font-semibold text-gray-900">
                                            {(() => {
                                                ...
                                                return method ? `$${Number(method.cost).toFixed(2)}` : '$0.00';
                                            })()}
                                        </span>
                                    </div>
