                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1" x-data="{ show: false }">
                            <x-admin.form.group label="New Password" for="password">
                                ...
                                <div class="relative">
                                    <x-admin.form.input x-bind:type="show ? 'text' : 'password'" name="password" id="password" />
                            ...
                            <div class="relative bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600 transition-all hover:border-primary/50">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-admin.form.input type="text" x-bind:name="'addresses[' + (address.id || address.tempId) + '][state]'" x-model="address.state" class="mt-1" x-bind:id="'province_' + index" />
                                    </div>
                                    <div>
