            ...
            <form method="POST" action="{{ route('admin.products.store') }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-admin.form.input id="name" name="name" :value="old('name')" required autofocus />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-admin.form.input id="box_price" name="box_price" type="number" step="0.01" :value="old('box_price')" required />
                        ...
                        <div>
                            ...
                            <x-admin.form.input id="unit_price" name="unit_price" type="number" step="0.01" :value="old('unit_price')" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-admin.form.input id="packaging" name="packaging" :value="old('packaging')" />
