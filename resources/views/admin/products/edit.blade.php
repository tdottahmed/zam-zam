            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-admin.form.input id="pcs_in_ctn" name="pcs_in_ctn" :value="old('pcs_in_ctn', $product->pcs_in_ctn)" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-admin.form.input id="box_price" name="box_price" type="number" step="0.01" :value="old('box_price', $product->box_price)" />
                    ...
                    <div>
                        ...
                        <x-admin.form.input id="unit_price" name="unit_price" type="number" step="0.01" :value="old('unit_price', $product->unit_price)" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-admin.form.input id="tax" name="tax" type="number" step="0.01" :value="old('tax', $product->tax)" />
