...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <x-admin.actions.button href="{{ route('admin.credit-notes.create') }}">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <x-admin.ui.td class="text-right">
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('admin.credit-notes.export-pdf', $cn) }}" target="_blank" class="text-gray-400 hover:text-green-600 transition-colors" title="Print PDF">
                            ...
                            @if(in_array($cn->status, ['draft', 'pending']))
                                <a href="{{ route('admin.credit-notes.edit', $cn) }}" class="text-gray-400 hover:text-green-600 transition-colors" title="Edit Request">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </a>
                                
                                <form action="{{ route('admin.credit-notes.destroy', $cn) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this credit note request?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-gray-400 hover:text-[#C41E3A] transition-colors bg-transparent border-0 p-0" title="Delete Request">
