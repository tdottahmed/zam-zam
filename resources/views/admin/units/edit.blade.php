        ...
        <form method="POST" action="{{ route('admin.units.update', $unit) }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-1" x-data="{ selected: '{{ old('type', $unit->type) }}' }">
                ...
                <div>
                    <label for="is_active" class="inline-flex items-center cursor-pointer">
                        <input id="is_active" type="checkbox" class="rounded border-gray-300 text-[#C41E3A] shadow-sm focus:ring-[#C41E3A]" name="is_active" value="1" {{ old('is_active', $unit->is_active) ? 'checked' : '' }}>
