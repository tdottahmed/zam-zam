...
<body>
  ...
  <div class="invoice-title">Order {{ $data['order_number'] }}</div>
    ...
    <table style="width: 100%; border-collapse: separate; border-spacing: 0;">
      <tr>
        <td style="background-color: #f5f5f5; padding: 10px; border-radius: 5px; width: 14%;">
          <div style="font-size: 9px; text-transform: uppercase; color: #888; font-weight: bold;">Order Date</div>
          <div style="font-size: 11px; font-weight: bold; color: #333; margin-top: 3px;">{{ $data['order_date'] }}
          </div>
        </td>
        <td style="background-color: #f5f5f5; padding: 10px; border-radius: 5px; width: 14%;">
  ...
  <div class="totals-section">
    ...
    <div style="float: left; width: 50%;">
      ...
      <div style="margin-top: 20px;">
        Please use the following communication for your payment : {{ $data['order_number'] }}
      </div>
    </div>
